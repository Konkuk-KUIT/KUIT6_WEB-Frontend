...
export function FilterableProductTable() {
  ...
  const [items, setItems] = useState(INITIAL_PRODUCT_LIST);

  const handleEditProduct = (index, newName, newPrice) => {
  ...
  return (
    <>
      ...
      />
      <ProductTable products={filteredProducts} onEditProduct={handleEditProduct} allItems={items} />
    </>
  );
}
