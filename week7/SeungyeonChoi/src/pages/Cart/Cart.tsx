...
const Cart = () => {
  ...
  return (
    <div className="w-[390px] h-[844px] bg-white mx-auto relative overflow-hidden pb-32">
      ...
      <div className="px-5 py-4 bg-white flex justify-between text-sm">
        <span className="font-semibold text-[17px] text-[#6B7684]">
          {store.name}
        </span>
        <div className="flex items-center gap-1 text-[#F04452]">
          <span className="text-[15px]">최소금액 미달</span>
          <img src="/src/assets/warning.svg" alt="주의" className="w-3 h-3" />
        </div>
      </div>
      ...
      <div className="px-5 py-4 text-[17px] text-[#3182F6] text-center font-semibold border-b-16 border-[#F2F4F6]">
        더 담기 +
      </div>
